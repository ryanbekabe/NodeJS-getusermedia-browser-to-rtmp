...
const server = require('https').createServer({
 key: fs.readFileSync('/etc/letsencrypt/live/juli.my.id/privkey.pem'),
  cert: fs.readFileSync('/etc/letsencrypt/live/juli.my.id/fullchain.pem')
...
server.listen(4433, function(){
  console.log('https and websocket listening on *:4433');
});
